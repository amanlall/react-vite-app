   ...
   return (
    ...
    >
      ...
      <Reveal children={<div className="greeting">
        Hey, I'm <span className="brandshadow text-curtainColor">Aman.</span>
      </div>}/>
      <Reveal children={<div className="aboutme">
        I'm a <span className="text-curtainColor ">Full Stack Developer</span>
      </div>}/>
      ...
      <Reveal children={ <div className="ml-10 text-[#fdfdfd] sm:text-[1rem] md:text-[1rem] lg:text-[2rem] xl:text-3xl font-bold pb-1">PROJECTS<span className='text-curtainColor'>.</span></div>}/>
